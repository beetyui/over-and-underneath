...
if(l4CC419CD_0)
{
	...
	var l2EDBAF8B_0 = sprite_get_width(spr_hud_heart);
	var l2EDBAF8B_1 = 0;
	for(var l2EDBAF8B_2 = obj_player.hearts; l2EDBAF8B_2 > 0; --l2EDBAF8B_2) {
		draw_sprite(spr_hud_heart, 0, 0 + l2EDBAF8B_1, 15);
		l2EDBAF8B_1 += l2EDBAF8B_0;
	}
}